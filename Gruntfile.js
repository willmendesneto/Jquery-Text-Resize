...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    yeoman: {
      ...
      dist: 'dist',
      moduleName: 'jquery-text-resize',
      moduleDescription: 'Manipulation and Resizing text',
      moduleUrl: 'http://willmendesneto.github.io/Jquery­Text­Resize/',
      docs: 'docs'
    },
    ...
    jshint: {
      options: {
        ...
        ignores: [
          ...
          'app/scripts/jquery-1.7.1.min.js',
  ...
  grunt.registerTask('buildNgModuleFile', 'Task for build ng module script file.', function(filename) {
    ...
    var buildFile = function(filename){
      ...
      data = templateNgModule.header + data + templateNgModule.footer;
